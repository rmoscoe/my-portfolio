...
export default function Software() {
    const [projects] = useState([
        ...
        },
        {
            ...
            description: "Odyssey uses the Google Gemini generative AI to craft thrilling adventures for tabletop roleplaying games in seconds. Choose from a large selection of the most popular games, enter a lesser-known title, or describe an unpublished/homebrew game. Refine your request with a campaign setting, number of players, experience level, and other parameters.",
            techStack: ["MySQL", "Python", "Django", "Gemini", "Gencraft", "Vite", "TypeScript", "React", "CSS", "TailwindCSS", "Heroku"],
            team: "solo",
            scope: "full-stack",
            starterCode: false,
            defaultPosition: 5
